...
public class AppMetricaObject : ScriptableObject
{
    ...
    public void GameStart()
    {
        ...
        Dictionary<string, object> eventProps3 = new Dictionary<string, object>();
        eventProps3.Add("day", reg_day.ToString());
        AppMetrica.Instance.ReportEvent("reg_day", eventProps3);

        Dictionary<string, object> eventProps4 = new Dictionary<string, object>();
        eventProps4.Add("count", days);
        AppMetrica.Instance.ReportEvent("days_in_game", eventProps4);
    }
    ...
    public void LevelComplete(int levelNumber, int soft)
    {
        Dictionary<string, object> eventProps = new Dictionary<string, object>();
        ...
        Dictionary<string, object> eventProps2 = new Dictionary<string, object>();
        eventProps2.Add("soft", soft);
        AppMetrica.Instance.ReportEvent("current_soft", eventProps2);
    }
